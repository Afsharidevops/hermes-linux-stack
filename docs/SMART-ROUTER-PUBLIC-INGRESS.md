...
Do not expose Smart Router `:8080` directly to the Internet. Keep `omniroute:20128` and other administration interfaces private/VPN-only unless you intentionally add separate access control. `/metrics` should remain private.
