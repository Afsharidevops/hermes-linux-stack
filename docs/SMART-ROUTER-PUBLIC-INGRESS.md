...
Keep administrative services such as the OmniRoute dashboard, Hermes dashboard, and n8n editor private unless you have a separate authentication/access-control layer in front of them.
