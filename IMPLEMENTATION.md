# Smart Router v0.5.5 implementation notes

This branch uses the shared Smart Router v0.5.5 implementation in front of **OmniRoute**.

## Data plane

`Hermes / Open WebUI / n8n -> Smart Router v0.5.5 -> OmniRoute -> provider/model`
...
6. For HA, configure PostgreSQL + Redis and use the v0.5.5 HA reference Compose file; Redis sticky state is selected automatically when configured.
