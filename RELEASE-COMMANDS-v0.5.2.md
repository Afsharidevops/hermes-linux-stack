# v0.5.2 release commands — `hermes-omniroute-linux-stack`
...
rsync -a --delete \
  ...
  --exclude='.env' \
  --exclude='data/' \
  /path/to/hermes-linux-stack-hermes-omniroute-linux-stack-v0.5.2/ ./

git add -A
git status
git commit -m "feat: Hermes Smart Router v0.5.2 (hermes-omniroute-linux-stack)"
